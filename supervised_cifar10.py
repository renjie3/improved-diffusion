...
def train(epoch, optimizer):
    ...
    for pos_1, targets in train_bar:
...
if __name__ == '__main__':
    ...
    train_files = _list_image_files_recursively("/mnt/home/renjie3/Documents/unlearnable/diffusion/improved-diffusion/datasets/cifar_train")
    ...
    test_files = _list_image_files_recursively("/mnt/home/renjie3/Documents/unlearnable/diffusion/improved-diffusion/datasets/cifar_test")
    ...
    # plot_loss('./results/supervised/{}_statistics'.format(save_name_pre))
