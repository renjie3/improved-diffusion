...
TRAIN_FLAGS="--save_interval 10000 --lr 1e-4 --batch_size 256 --stop_steps 125000 --microbatch -1 --class_cond False --num_workers 8"
...
SAMPLE_FLAGS="--batch_size 128 --num_samples 1000 --model_path /mnt/home/renjie3/Documents/unlearnable/diffusion/improved-diffusion/results/146/model150000.pt --out_dir /mnt/home/renjie3/Documents/unlearnable/diffusion/improved-diffusion/results/146/model150000"

JOB_INFO="train stepsize"
MYCOMMEND="mpiexec -n 2 python -u scripts/image_train.py --data_dir datasets/CIFAR100_clean_freq $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS $ADV_FLAGS $POISON_FLAGS"
