...
DIFFUSION_FLAGS="--diffusion_steps 4000 --noise_schedule cosine --save_interval 2500"
TRAIN_FLAGS="--lr 1e-4 --batch_size 128"

JOB_INFO="train stepsize"
MYCOMMEND="mpiexec -n 4 python scripts/image_train.py --data_dir datasets/cifar_train $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS"
