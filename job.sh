...
TRAIN_FLAGS="--save_interval 10000 --lr 1e-4 --batch_size 10 --source_batch_size 10 --lr_anneal_steps 0 --stop_steps 300000 --microbatch -1 --class_cond False --load_model True --model_path /mnt/home/renjie3/Documents/unlearnable/diffusion/improved-diffusion/results/91/model001000.pt"
