...
POISON_FLAG="--poisoned True --poisoned_path /egr/research-dselab/renjie3/renjie/improved-diffusion/results/19/adv_noise"

# model102400.pt ema_0.9999_102400.pt


GPU_ID='2,3'
MY_CMD="mpiexec -n 2 python -u scripts/image_train.py --data_dir /localscratch/renjie/sub_cifar_train $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS $ADV_FLAG $POISON_FLAG"
MY_ROOT_PATH=`pwd`
