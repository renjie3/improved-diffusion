...
TRAIN_FLAGS="--save_interval 10000 --lr 1e-4 --batch_size 96 --stop_steps 500000 --microbatch -1 --class_cond True --num_workers 8"
...
SAMPLE_FLAGS="--batch_size 64 --num_samples 5000 --model_path /egr/research-dselab/renjie3/renjie/improved-diffusion/results/268/ema_0.9999_500000.pt --out_dir /egr/research-dselab/renjie3/renjie/improved-diffusion/results/268/ema_0.9999_500000 --class_cond False --sample_class 0"

GPU_ID='0'
MY_CMD="mpiexec -n 1 python -u scripts/image_train.py --data_dir /localscratch/renjie/stl10_label3_freq $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS $ADV_FLAGS $POISON_FLAGS"
