...
TRAIN_FLAGS="--save_interval 6400 --lr 1e-4 --batch_size 100 --microbatch -1 --class_cond False --load_model True --model_path /home/renjie3/improved-diffusion/results/30/model064000.pt"
ADV_FLAGS="--mode adv --output_index True --output_class True --adv_noise_num 5000 --adv_step 30 --save_forward_clean_sample False --single_target_image_id 5000 --adv_loss_type forward_bachword_loss --group_model_dir /home/renjie3/improved-diffusion/results/30 --group_model False --group_model_num 20 --random_noise_every_adv_step True --t_seg_num 8 --t_seg_start 3 --eot_gaussian_num 5"
POISON_FLAGS="--poisoned False --poisoned_path /home/renjie3/improved-diffusion/results/40/adv_noise"
...
GPU_ID='2'
MY_CMD="mpiexec -n 1 python -u scripts/image_train.py --data_dir /home/renjie3/improved-diffusion/datasets/sub_cifar_train_bird_horse $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS $ADV_FLAGS $POISON_FLAGS"
MY_ROOT_PATH=`pwd`
