...
GPU_ID='5'
MY_CMD="mpiexec -n 1 python -u scripts/image_train.py --data_dir /localscratch/renjie/sub_cifar_train_2class $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS $ADV_FLAG $POISON_FLAG"
MY_ROOT_PATH=`pwd`
