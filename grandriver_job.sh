...
TRAIN_FLAGS="--save_interval 10000 --lr 1e-4 --batch_size 96 --stop_steps 222222 --microbatch -1 --class_cond True --num_workers 8"
...
GPU_ID='0, 1, 2'
MY_CMD="mpiexec -n 3 python -u scripts/image_train.py --data_dir /localscratch/renjie/stl_freq $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS $ADV_FLAGS $POISON_FLAGS"
MY_ROOT_PATH=`pwd`
