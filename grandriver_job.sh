...
ADV_FLAGS="--mode adv --output_index True --output_class True --adv_noise_num 5000 --load_model False --model_path /home/renjie3/improved-diffusion/results/30/model064000.pt --adv_step 30 --save_forward_clean_sample False --single_target_image_id 5000 --adv_loss_type negative_forward_bachword_loss --group_model_dir /home/renjie3/improved-diffusion/results/30 --group_model True --group_model_num 20 --random_noise_every_adv_step True"
