...
TRAIN_FLAGS="--save_interval 10000 --lr 1e-4 --batch_size 32 --stop_steps 500000 --microbatch -1 --class_cond False --num_workers 8"
...
GPU_ID='4, 5'
MY_CMD="mpiexec -n 2 python -u scripts/image_train.py --data_dir /egr/research-dselab/renjie3/renjie/improved-diffusion/datasets/stl_hidden_64 $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS $ADV_FLAGS $POISON_FLAGS"
