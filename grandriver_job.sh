...
TRAIN_FLAGS="--save_interval 12800 --lr 1e-4 --batch_size 100 --microbatch -1 --class_cond False"
...
GPU_ID='0,1,2,3'
MY_CMD="mpiexec -n 4 python scripts/image_train.py --data_dir /home/renjie3/improved-diffusion/datasets/sub_cifar_train_3class $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS $ADV_FLAG"
MY_ROOT_PATH=`pwd`
